...
--- [SECCIÓN: Variante con `for`] ---

La variante equivalente que usa un `for` (avanza el índice sólo cuando la nota es válida) puede implementarse en otra clase o en lugar del `while`. Ejemplo:
